...
47 total reference problems in LiveCoding, 10 solved through a real mentor session (containsDuplicate, twoSum, validAnagram, groupAnagrams, topKFrequent, productExceptSelf, longestConsecutiveSequence, encodeAndDecodeStrings, firstUniqChar, reverseWords — all Arrays & Hashing). Phase 0 is done, Arrays & Hashing is done. Moving to Two Pointers next, starting with validPalindrome.
