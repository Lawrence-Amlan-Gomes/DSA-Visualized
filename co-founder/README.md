...
| [mail-recipients.md](mail-recipients.md) | Other projects' `mail-box/` folder paths this mentor sends a session-summary mail to on `End Today` | Read every `End Today`; edited whenever Lawrence adds/removes a recipient |
